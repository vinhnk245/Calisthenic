    ...
    <div class="content-page">
        ...
        <div class="content">
			...
			<div class="container-fluid">
				...
				<div class="row" id="getExerciseId" data-id="<?php echo $id?>">
	                <div class="col-md-12 text-right">
	                    <div class="breadcrumb-holder">
	                    	<h1 class="main-title float-left pt-0 pb-3">
	                    		<i class="fa fa-fw fa-beer"></i>Edit exercise
	                    	</h1>
...
<script type="text/javascript" src="../js/editExercisePresenter.js"></script>